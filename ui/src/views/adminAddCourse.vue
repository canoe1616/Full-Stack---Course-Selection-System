      ...
      <b-row>
        <b-col xs="12" sm="9">
          <b-form>
            ...
            >
              <b-form-input id="instructor-input" v-model="instructor" required />
            </b-form-group>
            <b-form-group
              label="startTime:"
          ...
          <b-button @click ="handleClickAddCourse"><b-icon-plus-circle /></b-button>
        </b-col>
          <!-- <b-button 
...
async function handleClickAddCourse() {
    await addCourseInfo(
        courseId.value,name.value,instructor.value,startTime.value,endTime.value,status.value,weekdays.value,capacity.value
    )
